            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                <div className="banner-left-text">
                  ...
                  <p className="banner-text">
                    Through our Printed Edition Rotation Program, your hotel will
                    be featured as one of the top Luxury Hotels and will ensure a
                    continuous influx of bookings and a consistent occupancy rate
                    of 800,000 to 1 million tourists throughout the year, all
