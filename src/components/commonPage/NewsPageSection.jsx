...
const NewsletterSection = () => {
  ...
  return (
    <>
      ...
      <section className="section-padding-newsletter" style={{position:"relative", top:"-100px"}}>
        <div className="container">
          <div className="flex flex-col md:flex-row items-center text-white ">
            ...
            <div className="md:w-2/3 mt-[-50px] md:mt-0 md:ml-8 md:text-left">
              <h3 className="text-2xl text-center font-bold">SIGN UP For Our NEWSLETTER</h3>
              <p className="mt-3 text-center font-bold">
                {/* SIGN UP NOW TO RECEIVE HOT SPECIAL OFFERS AND INFORMATION ABOUT THE
                BEST TOURS! */}
                {/* TO RECEIVE THE LATEST NEWS, EXCLUSIVE DEALS, AND A CHANCE TO WIN A FREE HOLIDAY WHILE DISCOVERING THE BEST LUXURY HOTELS AND TOP DESTINATIONS! */}
